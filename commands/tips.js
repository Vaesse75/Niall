...
module.exports = {
	...
	execute(msg, args) {
		var text = [
			...
			"**Method for Deciding When There Are No Pros or Cons to Use**\n- First make a list of everything you're deciding between.\n- Then number everything on the list.\n- Then use a random number generator (or a die) to choose a number.  (Note: I can help if you use `!roll d??` where ?? is the number of items you're deciding between.)\n- If you **immediately** wish another number came up, that's your answer.\n- Otherwise, choose whatever was selected.",
			"Break as many things as you can into smaller steps. This can be done by checklists in daily or to-dos or extra habits.  Ask your party members if you need help breaking a task down.",
